...
class DispatcherBD:
    ...
    def authenticate(self):
        ...
        if self.connect_to_db(login, password):
            ...
            messagebox.showerror("Login Failed", "Failed to connect to the database with the provided credentials.")
    ...
    def database_exists(self):
        with psycopg2.connect(dbname="postgres", user="postgres", host=DB_HOST, port=DB_PORT) as conn:
